...
| :--- | :--- | :--- | :--- |
| **v8.0.0** | **Latest Major (Recommended)** | `v8.0.0` | `git clone -b v8.0.0 https://github.com/razenry/zen-fr.git` |
...
```bash
# Clone versi terbaru v8.0.0
git clone -b v8.0.0 https://github.com/razenry/zen-fr.git my-project
...
Zen PHP v8.0.0 menyediakan 3 mode siap pakai sesuai kebutuhan arsitektur aplikasi Anda:

### 1. REST API Dedicated (`php zen preset:api`)
- Mode murni Backend REST API tanpa view overhead.
...
- Integrasi React 18 SPA/Hybrid dengan bundler Vite HMR dan TailwindCSS.
...
- Server-side rendering HTML reaktif tanpa perlu install Node.js atau bundler eksternal.

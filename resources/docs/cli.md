...
## Perintah Keamanan & Optimasi

```bash
# Menghasilkan APP_KEY enkripsi 32-byte pada file .env
php zen key:generate

# Mengompilasi rute web & API ke dalam file cache untuk kecepatan O(1)
php zen route:cache

# Menghapus file cache rute
php zen route:clear

# Mengompilasi classmap PSR-4 Composer dan route cache (Production Ready)
php zen optimize

# Membersihkan seluruh cache optimasi
